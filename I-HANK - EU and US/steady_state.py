...
def find_ss(model, do_print=False):
    ...
    if do_print:
        ...
        print(f'{ss.CB_us = :.3f}')
        print(f'{ss.GDP = :.3f}')
        print(f'{par.omega_TH_HH_eu = :.3f}')
        print(f'{par.omega_TH_HL_eu = :.3f}')
        print(f'{par.omega_TH_LH_eu = :.3f}')
        print(f'{par.omega_TH_LL_eu = :.3f}')
        print(f'{par.omega_TH_HH_us = :.3f}')
